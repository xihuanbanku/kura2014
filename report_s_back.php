...
<table width="100%" border="0" id="table_style_all" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2">
     <tr>
      <td><strong>&nbsp;顧客返品レポート</strong>&nbsp;&nbsp;<a href="report_s_back.php?type=day">日報</a> | <a href="report_s_back.php?type=week">週報</a> | <a href="report_s_back.php?type=month">月報</a> | <a href="report_s_back.php?type=year">年報</a>&nbsp;&nbsp;<input type="button" onClick="preview(1);" value=" 印刷 "></td>
     </tr>
     <tr>
      <td bgcolor="#FFFFFF">
     <?php
	  ...
	  ?>
       ...
       <form action="report_s_back.php?action=save&type=day" name="form1" method="post">
	    <tr height="40">
	   ...
	   ?>
       <table width="100%" cellspacing="0" cellpadding="0" border="0" id="table_border">
       <form action="report_s_back.php?action=save&type=week" name="form1" method="post">
	    <tr height="40">
	   ...
	   ?>
       <table width="100%" cellspacing="0" cellpadding="0" border="0" id="table_border">
       <form action="report_s_back.php?action=save&type=month" name="form1" method="post">
	    <tr height="40">
	   ...
	   ?>
       <table width="100%" cellspacing="0" cellpadding="0" border="0" id="table_border">
       <form action="report_s_back.php?action=save&type=year" name="form1" method="post">
	    <tr height="40">
