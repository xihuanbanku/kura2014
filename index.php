...
<frameset rows="90,*,27" cols="*" frameborder="0" framespacing="0">
 ...
 <frameset cols="180,*" frameborder="0">
  <frame src="menu.php" name="menu" id="menu" noresize="noresize" frameborder="0" scrolling="auto"/>
  <frame src="main.php" name="main" id="main" noresize="noresize" frameborder="0"/>
 </frameset>
