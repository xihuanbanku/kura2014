...
<font face=webdings style=color:#000000 title="去年">7</font> 
</a> 
<td width=30 align=center> 
<a href=getday.php?form=<?php echorequest("form") ?>&field=<?php echo $_GET['form']; ?>&mm=<?php echo (mm-1)?>&yy=<?php echo yy ?>> 
<font face=webdings style=color:#000000 title="先月">3</font> 
</a> 
...
<font face=webdings style=color:#000000 title="来月">4</font> 
</a> 
<td width=30 align=center> 
<a href=getday.php?form=<?php echo $_GET['form']; ?>&field=<?php echo $_GET['field']; ?>&yy=<?php echo (yy+1)?>&mm=<?php echo mm ?>> 
<font face=webdings style=color:#000000 title="来年">8</font> 
</a> 
</table> 
<tr bgcolor=#ffffff height=20> 
<td width=35 align=center bgcolor=#FFF4F4 style="color:#ff6633;">日 
<td width=35 align=center bgcolor=#FFF4F4>月 
<td width=35 align=center bgcolor=#FFF4F4>火 
<td width=35 align=center bgcolor=#FFF4F4>水 
<td width=35 align=center bgcolor=#FFF4F4>木 
<td width=35 align=center bgcolor=#FFF4F4>金 
<td width=35 align=center bgcolor=#FFF4F4>土 
<% 
if week1<>0 then 
response.write "<tr>" 
for i=1 to week1 
...
onclick="javascript:getDay('<?php echo yy ?>-<?php echo mm ?>-<?php echo i ?>');" title="<?php echo yy ?>年<?php echo mm ?>月<?php echo i ?>日（本日）"> 
<% 
else 
 ?> 
