...
$(function(){
	...
	var url = "../service/ProductService.class.php";
	$.ajax({
		type: "post",
		url: url,
		data: {"flag":"initTotal"},
...
// 		}
	...
	$.ajax({
		type: "post",
		url: "../service/ProductService.class.php?" + param,
		data: {"flag":"writeNote",
...
function show_buying() {
	...
	$("#table_border tr:gt(0) input[type=checkbox]:checked").each(function(i, item){
		...
		if($(item).parent().nextAll(":eq(6)").text() == "6-6-6-6-6") {
			alert("["+$(item).parent().next().text() + "]请输入主号信息");
			return false;
		}
		html+=""
			+"<tr>"
...
function initPage(pageIndex) {
	...
	var pageCount = 20;
	var recordCount = 0;
	var url = "../service/ProductService.class.php?"+$("select").serialize()+"&pageCount="+pageCount+"&pageIndex="+(pageIndex+1)+"&nocache="+new Date().getTime()+"&sstate12=<?php echo $_REQUEST["sstate12"]?>";
	var param = $("input").serialize();
	$.ajax({
		type: "post",
		url: url+"&"+param,
...
//     		alert(data);
    		...
    		$.each(data.results, function(entryIndex, entry){
    			...
    			if($("input[name=editA]").val() == "1") {
    				html+="	<a target=\"_blank\" href=\"product_edit.php?id=" + entry.kid+" \">修正</a>";
    			}
    			if($("input[name=deleteA]").val() == "1") {
    				html+="|<a onclick=\"submitChk(" + entry.kid + ",'" + entry.cp_number + "')\" href=\"#\">削除</a>";
    			}
    			<?php } ?>
    			html+="	</td><td><a target=\"_blank\" href=\"product_basic_refer.php?id=" + entry.cp_number + "\" style=\"text-decoration:underline\">" + entry.cp_number + "</a></td>"
    			...
    			+"	<td align=\"right\"><font color=\"blue\">￥" + entry.cp_sale + "</font></td>"
...
function out_excel(shop, btnflag){
	var param = $("input").serialize();
	var url = "../service/ProductService.class.php?"+$("select").serialize()+"&nocache="+new Date().getTime()+"&"+param+"&flag=out_excel&shop="+shop+"&btnflag="+btnflag;
    	        ...
    	        <div id="searchDiv">
                   ...
                   关键字：
                    <select name="searchType">
                        ...
                        <option value="cp_sale">販売価格</option>
    ...
    <div id="dialog" title="选择要导出的列...">
        <table >
            ...
            <tr>
                ...
                <td><label><input type="checkbox" name="columns[]" value="18"/>メーカー希望卸売価格</label></td>
                <td><label><input type="checkbox" name="columns[]" value="19"/>販売価格</label></td>
            </tr>
            <tr>
                <td><label><input type="checkbox" name="columns[]" value="20"/>生産日付</label></td>
                <td><label><input type="checkbox" name="columns[]" value="21"/>廃棄日付</label></td>
                <td><label><input type="checkbox" name="columns[]" value="22"/>仕入先</label></td>
                <td><label><input type="checkbox" name="columns[]" value="23"/>メインURL</label></td>
                <td><label><input type="checkbox" name="columns[]" value="24"/>サブURL1</label></td>
            </tr> 
            <tr>
                <td><label><input type="checkbox" name="columns[]" value="25"/>サブURL2</label></td>
                <td><label><input type="checkbox" name="columns[]" value="26"/>サブURL3</label></td>
                <td><label><input type="checkbox" name="columns[]" value="27"/>サブURL4</label></td>
                <td><label><input type="checkbox" name="columns[]" value="28"/>推奨ブラウズノード1</label></td>
                <td><label><input type="checkbox" name="columns[]" value="29"/>推奨ブラウズノード2</label></td>
            </tr>
            <tr>
                <td><label><input type="checkbox" name="columns[]" value="30"/>キーワード1</label></td>
                <td><label><input type="checkbox" name="columns[]" value="31"/>キーワード2</label></td>
                <td><label><input type="checkbox" name="columns[]" value="32"/>キーワード3</label></td>
                <td><label><input type="checkbox" name="columns[]" value="33"/>キーワード4</label></td>
                <td><label><input type="checkbox" name="columns[]" value="34"/>キーワード5</label></td>
            </tr>
            <tr>
                <td><label><input type="checkbox" name="columns[]" value="35"/>キーワード6</label></td>
                <td><label><input type="checkbox" name="columns[]" value="36"/>キーワード7</label></td>
                <td><label><input type="checkbox" name="columns[]" value="37"/>キーワード8</label></td>
                <td><label><input type="checkbox" name="columns[]" value="38"/>キーワード9</label></td>
                <td><label><input type="checkbox" name="columns[]" value="39"/>キーワード10</label></td>
            </tr>
            <tr>
                <td><label><input type="checkbox" name="columns[]" value="40"/>mainkc ID</label></td>
                <td><label><input type="checkbox" name="columns[]" value="41"/>倉庫号</label></td>
                <td><label><input type="checkbox" name="columns[]" value="42"/>在庫位置</label></td>
                <td><label><input type="checkbox" name="columns[]" value="43"/>在庫数</label></td>
                <td><label><input type="checkbox" name="columns[]" value="44"/>状態1</label></td>
            </tr>
            <tr>
                <td><label><input type="checkbox" name="columns[]" value="45"/>状態2</label></td>
                <td><label><input type="checkbox" name="columns[]" value="46"/>状態3</label></td>
                <td><label><input type="checkbox" name="columns[]" value="47"/>状態4</label></td>
                <td><label><input type="checkbox" name="columns[]" value="48"/>状態5</label></td>
                <td><label><input type="checkbox" name="columns[]" value="49"/>状態6</label></td>
            </tr>
            <tr>
                <td><label><input type="checkbox" name="columns[]" value="50"/>状態7</label></td>
                <td><label><input type="checkbox" name="columns[]" value="51"/>状態8</label></td>
                <td><label><input type="checkbox" name="columns[]" value="52"/>状態9</label></td>
                <td><label><input type="checkbox" name="columns[]" value="53"/>状態10</label></td>
                <td><label><input type="checkbox" name="columns[]" value="54"/>笔记</label></td>
            </tr>
            <tr>
                <td><label><input type="checkbox" name="columns[]" value="55"/>備考</label></td>
                <td><label><input type="checkbox" name="columns[]" value="56"/>ASIN</label></td>
            </tr>
        </table>
