...
//                 echo($csv_data);
            ...
            case "export":
                ...
                $array = array("CONTROL","P_CODE","BAR_CODE","PARENT","MAKER","TITLE","EXAMPLE","DETAIL","BULLET1","BULLET2","BULLET3",
                    ...
                    "STATE1","STATE2","STATE3","STATE4","STATE5","STATE6","STATE7","STATE8","STATE9","STATE10","NOTE","BZ","ASIN","V_NUMBER","TOTAL_NUMBER");
                for ($i=0;$i<count($array); $i++) {
					if($columnsArray[$i]){
                ...
                $array = array("コントロール","商品コード","バーコード","親子関連","メーカ","タイトル","仕様","商品説明","箇条書き1",
                            ...
                            "状態1","状態2","状態3","状態4","状態5","状態6","状態7","状態8","状態9","状態10","注釈","備考","ASIN","仮想数","更新用在庫");
                for ($i=0;$i<count($array); $i++) {
					if($columnsArray[$i]){
