<?php
    require_once(dirname(__FILE__)."/fix_mysql.inc.php");
	/**********************************************************************
	...
	*/
	...
	class ezSQL_mysql extends ezSQLcore
	{
		...
		*/
		...
		function ezSQL_mysql($dbuser='pmon_test', $dbpassword='erise2013', $dbname='pmon_kura', $dbhost='mysql706a.xserver.jp', $encoding='utf8')
		{
			$this->dbuser = $dbuser;
		...
		*/
		...
		function quick_connect($dbuser='pmon_test', $dbpassword='erise2013', $dbname='pmon_kura', $dbhost='mysql706a.xserver.jp', $encoding='utf8')
		{
			$return_val = false;
		...
		*/
		...
		function connect($dbuser='pmon_test', $dbpassword='erise2013', $dbhost='mysql706a.xserver.jp')
		{
		...
		*/
		...
		function select($dbname='pmon_kura', $encoding='')
		{
			global $ezsql_mysql_str; $return_val = false;
		...
		*/
		...
		{
	        $prefix="#@__";
		    $query = str_replace($prefix, "jxc_",$query);
		    error_log(date("Ymd-H:i:s")."----[".$_COOKIE["VioomaUserID"]."]".$query."\n", 3, dirname(__FILE__)."/../logs/sql".date("Ymd").".log");
